...
describe Curupira::RelationshipSelectOptionsHelper do
  describe "#active_user_groups_select_options" do
    let!(:active_group1) { FactoryGirl.create(:user_group, active: true) }
    let!(:active_group2) { FactoryGirl.create(:user_group, active: true) }
    let!(:inactive_group) { FactoryGirl.create(:user_group, active: false) }
